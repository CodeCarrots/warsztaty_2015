...
#Użycia funkcji z argumentami oraz zwrotami ->
#Wybierz symbol (1), możliwe wartości to ('a', 'A', 'b', 'B', 'c', 'C'): a
#Odp. usera (1): a
#Wybierz symbol (2), możliwe wartości to aAbBcC: x
#Wybierz symbol (2), możliwe wartości to aAbBcC: b
#Odp. usera (2): b
