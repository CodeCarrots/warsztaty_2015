...
#tech_mids_cnt = tech_mid_1xx_group_cnt + tech_mid_2xx_group_cnt + tech_mid_3xx_group_cnt
...
# przy nieparzystej liczbie MID-ów środkowy MID
tech_mid = tech_mids[int(tech_mids_cnt / 2)]
...
# re-używalność zmiennych, walidacja, ilość zmiennych
